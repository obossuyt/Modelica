...
equation
  ...
  connect(pump.port_b, heatPumpOnOff.port_a2) annotation (Line(
      points={{50,82},{60,82},{60,33.2},{30,33.2}},
      color={0,127,255},
      smooth=Smooth.None));
  annotation (
